...
Тесты и доработки выполнены на основе учебного Android-приложения. Исходный каркас приложения на Kotlin не выдаётся за разработанный с нуля. В репозиторий не включены задания, материалы курса и история учебного репозитория.
